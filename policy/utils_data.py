...
def load_data_std(args):
    problems = json.load(open(os.path.join(args.data_root, 'scienceqa/problems_rt_qar.json')))
    pid_splits = json.load(open(os.path.join(args.data_root, 'scienceqa/pid_splits_rt.json')))
...
def load_data_img_policy(args):
    problems = json.load(open(os.path.join(args.data_root, 'scienceqa/problems_policy_003.json')))
    # pid_splits = json.load(open(os.path.join(args.data_root, 'scienceqa/pid_splits.json')))
    captions = json.load(open(args.caption_file))["captions"]
    name_maps = json.load(open('vision_features/name_map_policy.json'))
