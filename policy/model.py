...
class policy_network(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.tokenizer = AutoTokenizer.from_pretrained("/data1/huyi/codes/PromptPG/bert-base-uncased")
        print("model_config:", model_config)
        self.model = AutoModelForTokenClassification.from_pretrained("/data1/huyi/codes/PromptPG/bert-base-uncased")
    ...
    def forward(self, input_list):
        input = self.tokenizer(input_list, truncation=True, padding=True, return_tensors="pt", max_length=512).to(self.model.device)
        # print(f"input: {input}")
